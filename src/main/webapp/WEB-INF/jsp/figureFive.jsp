...
<div class="chart">
    <form:form method="post" modelAttribute="selectForm">
        <form:select path="code" cssClass="select">
            <form:options items="${codeList}" itemValue="code" itemLabel="code" />
        </form:select>
        <input type="submit" class="select" value="Choose cmdCode"/>
    </form:form>
</div>
...
<script type="text/javascript">
  window.onload = function() {
    ...
    let chart = new CanvasJS.Chart("chartContainer", {
      ...
      title: {
        text: "Russia's gross import product with code ${productCode}",
